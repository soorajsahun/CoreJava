...
abstract class Parent extends GrandParent{
	...
	public Parent() {//the object of abstract class gets created but neither we can see it nor access it. 
		System.out.println("abstract class Parent cons called...");
	}
	public abstract void yoursSayHello();//normal abstract method
	final public void mySayHello() {//normal non abstract method//'final' methods cannot be overriden
